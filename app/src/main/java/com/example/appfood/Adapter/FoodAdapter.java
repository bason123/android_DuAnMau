...
public class FoodAdapter extends RecyclerView.Adapter<FoodAdapter.ViewHolder> {
    ...
    public FoodAdapter(ArrayList<Product> foodList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.product_food, parent, false);
